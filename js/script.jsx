var TodoBox = React.createClass({
  getInitialState: function() {
    return {
      data: [
        {"id": "001", "task":"整理房间", "complete": "false"},
        {"id": "002", "task":"学习", "complete": "false"},
        {"id": "003", "task":"做饭", "complete": "true"},
      ]
    };
  },
    ...
    return (
      <li className={classes}
        ...
        <div className="pull-right">
          <button type="button" className="btn close" onClick={this.deleteTask} ref="deleteBtn">删除</button>
        </div>
      </li>
    );
  }
...
var TodoFooter = React.createClass({
  render: function() {
    return (
      <li className="list-group-item">完成数：{this.props.todoCompleteCount} / 总共：{this.props.todoCount}</li>
    )
  }
});
        ...
        <form className="form-horizontal" onSubmit={this.submitTask}>
          <div className="form-group">
            ...
            <div className="col-md-10">
              <input type="text" id="task" ref="task" className="form-control" placeholder="添加新的任务"></input>
            </div>
          </div>
          <div className="row">
